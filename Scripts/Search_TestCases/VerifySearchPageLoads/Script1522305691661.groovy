...
if(WebUI.verifyElementVisible(findTestObject('Page_BugsUI Dashboard/a_Search'))){
...
WebUI.verifyElementText(findTestObject('Page_BugsUI Search/h3_Search Parameters'), 'Search Parameters :')
